...
- (void)viewDidLoad {
	...
	btn = [[UIBarButtonItem alloc] initWithTitle:@"地図に移動" style:UIBarButtonItemStylePlain target:self action:@selector(backButtonPushed)];
	[toolButtons addObject:btn];
	...
	const CGFloat kToolbarHeight = 60.0f;
...
- (CGPoint)pointInViewForArtile:(Article *)article {
	...
	point.y = appData.mapBorderY - [article.distance intValue] / 30;
